...
#define BOOSTED_REPEAT_KEYS KC_Z, KC_D, KC_R, KC_S
#define BOOSTED_REPEAT_KEY_COUNT 4
#define BOOSTED2_REPEAT_DELAY 200
#define BOOSTED2_REPEAT_TERM 11
#define BOOSTED2_REPEAT_KEYS KC_V, KC_Q
#define BOOSTED2_REPEAT_KEY_COUNT 2
